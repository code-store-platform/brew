class Codestore < Formula
  ...
  url "https://s3.code.store/codestore-v1.18.19/codestore-v1.18.19-darwin-x64.tar.gz"
  version "1.18.19"
  sha256 "5e5aa1b8e00247467f64afa679a6ccda8aca03c1e84a7ff5b2a71b75568365f6"
  license "MIT"
  depends_on "node@12"
